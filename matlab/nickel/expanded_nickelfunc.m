...
p_flux =  u(2).*dudx(1) + dudx(2);
n_flux = -u(3).*dudx(1) + dudx(3);
u_flux = beta.*v1.*v2.*w_pp(u(4)).*dudx(4) - v1.*v2.*lambda.*dudx(5) + dudx(4);
psi_flux = dudx(4);

c = [0; 1; 1; 1; 0];
f = [poisson_flux; Dp*p_flux; Dn*n_flux; Du*u_flux; psi_flux];
s = [u(2)-u(3); -v1.*u(2)/2; -v2.*u(3)/2; v1.*v2.*(v2.*u(3) - v1.*u(2))/2; -u(5)];
